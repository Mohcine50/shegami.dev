import { faBracket } from "@fortawesome/free-solid-svg-icons";
  ...
  return (
    <div className='skills'>
      ...
      <div className='skills-list'>
        <Skill skillName={"HTML"} level={80} />
        <Skill skillName={"CSS"} level={75} />
        <Skill skillName={"Javascript"} level={65} />
        <Skill skillName={"React Js"} level={60} />
        <Skill skillName={"Node Js"} level={50} />
        <Skill skillName={"MongoDb"} level={60} />
        <Skill skillName={"Redux"} level={78} />
        <Skill skillName={"React Native"} level={30} />
        <Skill skillName={"docker"} level={40} />
        <Skill skillName={"TDD and Tests"} level={40} />
        <Skill skillName={"GraphQl"} level={55} />
        <Skill skillName={"Git and Github"} level={85} />
      </div>
    </div>
  );
}
